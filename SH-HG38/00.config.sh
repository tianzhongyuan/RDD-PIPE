...
echo "fasta=/mnt/hgfs/chiapipe_simon/ref_genome/bwa_hg38_index/GRCh38.primary_assembly.genome.fa" >>  $FC
echo "genome=/mnt/hgfs/chiapipe_simon/ref_genome/genome_size/hg38.size.txt" >>  $FC
